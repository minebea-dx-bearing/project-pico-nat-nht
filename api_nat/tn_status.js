...
const NewStatusGetDailyStatusReport = async (dateQuery) => {
    ...
    try {
        let data = await dbNAT.query(`
            ...
            DECLARE @TargetEndDate DATETIME = '${dateTomorrow} 05:00'; -- เปลี่ยนวันที่ด้วย
            ...
            DECLARE @shiftStart NVARCHAR(50) = '05:00:00';
            DECLARE @shiftStop NVARCHAR(50) = '16:59:59';
            ...
            [summary_alarm] AS (
                SELECT
                    ...
                    occurred_end,
                    CASE 
                        WHEN DATEPART(HOUR, [occurred_start]) < 5 THEN 
