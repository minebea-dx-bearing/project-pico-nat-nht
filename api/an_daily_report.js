...
cron.schedule('1 7 * * *', async () => {
    ...
    console.log("NAT - AN - Running data reprod cron job for date:", dateToday, hours, moment().tz('Asia/Bangkok').format("YYYY-MM-DD HH:mm:ss"));
}, {
...
const getDailyReport = async (dateQuery) => {
    ...
    console.log("NAT - AN - prod...", dateToday, dateTomorrow);
    ...
    try {
        ...
        console.log("NAT - AN - prod insert error:", error);
        return {
            data: error.message,
            success: true,
